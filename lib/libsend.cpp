...
// id_lock si next_conn_id eliminate din sender
...
int setup_connection(uint32_t ip, uint16_t port)
{
    ...
    // mutex initializat inainte de orice
    ...
    syn_pe_port.conn_id = 0; // temporar, conn_id real vine din SYN-ACK
    ...
    // cons.insert are mutex deja initializat
